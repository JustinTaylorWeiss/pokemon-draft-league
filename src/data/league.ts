...
export interface Postseason {
   ...
   *
   * A coach's table stays the regular season, because that is the season they
   * played to get there and mixing seven playoff matches into it would flatter
   * whoever went furthest twice over. A Pokemon's does not: a knockout in a
   * final is a knockout, and there is no reason for the board to forget it.
   */
